    ...
    parts = {
        {
            rotated_sprite = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-1", {
                    priority = "very-low",
                    dice = 4,
                    direction_count = 128,
            ...
            rotated_sprite_shadow = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-1-shadow", {
                    priority = "very-low",
                    direction_count = 64,
            ...
            rotated_sprite_reflection = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-1-reflection", {
                    priority = "very-low",
                    direction_count = 64,
        ...
        {
            rotated_sprite = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-3", {
                    priority = "very-low",
                    direction_count = 128,
                    scale = 0.5 * CAMP_CRANE_SCALE
                }),
            rotated_sprite_shadow = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-3-shadow", {
                    priority = "very-low",
                    direction_count = 32,
                    scale = CAMP_CRANE_SCALE,
                    draw_as_shadow = true
            ...
            rotated_sprite_reflection = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-3-reflection", {
                    priority = "very-low",
                    direction_count = 8,
                    scale = 5 * CAMP_CRANE_SCALE
                }),
        ...
        {
            rotated_sprite = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-4", {
                    priority = "very-low",
                    direction_count = 128,
                    scale = 0.5 * CAMP_CRANE_SCALE
                }),
            rotated_sprite_shadow = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-4-shadow", {
                    priority = "very-low",
                    direction_count = 32,
                    scale = CAMP_CRANE_SCALE,
                    draw_as_shadow = true
            ...
            rotated_sprite_reflection = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-4-reflection", {
                    priority = "very-low",
                    direction_count = 8,
                    scale = 5 * CAMP_CRANE_SCALE
                }),
        ...
        {
            rotated_sprite = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-7", {
                    priority = "very-low",
                    direction_count = 128,
                    scale = 0.5 * CAMP_CRANE_SCALE
                }),
            rotated_sprite_shadow = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-7-shadow", {
                    priority = "very-low",
                    direction_count = 32,
                    scale = CAMP_CRANE_SCALE,
                    draw_as_shadow = true
            ...
            rotated_sprite_reflection = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-7-reflection", {
                    priority = "very-low",
                    direction_count = 8,
                    scale = 5 * CAMP_CRANE_SCALE
                }),
        ...
        {
            rotated_sprite = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-8", {
                    priority = "very-low",
                    direction_count = 64,
                    scale = 0.5 * CAMP_CRANE_SCALE
                }),
            rotated_sprite_shadow = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-8-shadow", {
                    priority = "very-low",
                    direction_count = 32,
                    scale = CAMP_CRANE_SCALE,
                    draw_as_shadow = true
            ...
            sprite_reflection = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-8-reflection", {
                    priority = "very-low",
                    scale = 5 * CAMP_CRANE_SCALE
                }),
            layer = -1,
        ...
        },
        {
            sprite = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-9", {
                    priority = "very-low",
                    scale = 0.5 * CAMP_CRANE_SCALE
                }),
            sprite_shadow = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-9-shadow", {
                    priority = "very-low",
                    scale = CAMP_CRANE_SCALE,
                    draw_as_shadow = true
                }),
            sprite_reflection = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-9-reflection", {
                    priority = "very-low",
                    scale = 5 * CAMP_CRANE_SCALE
                }),
        ...
        {
            sprite = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-10", {
                    priority = "very-low",
                    scale = 0.5 * CAMP_CRANE_SCALE
                }),
            sprite_shadow = util.sprite_load(
            ...
            sprite_reflection = util.sprite_load(
                "__wood-universe-assets__/graphics/entity/agricultural-camp/agricultural-camp-crane-10-reflection", {
                    priority = "very-low",
                    scale = 5 * CAMP_CRANE_SCALE
                }),
            layer = -3,
